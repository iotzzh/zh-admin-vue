<template>
  <el-dialog
    ...
    :show-close="
      modalConfig.showClose === undefined ? false : modalConfig.showClose
    "
  >
      ...
      <div class="header">
        ...
        <div class="right">
          <el-button link @click="zhModal.toggleFullScreen" type="primary">
            <i
              v-if="zhModal.fullscreen.value"
              class="iconfont icon-fullscreen-shrink"
            ></i>
    ...
    <template #footer v-if="modalConfig.footer">
      <span class="dialog-footer">
        <el-button
          ...
          v-if="
            modalConfig.footer?.hasCancelButton ||
            modalConfig.footer?.hasCancelButton === undefined
          "
          >取消</el-button
        >
        <el-button
          ...
          v-if="
            modalConfig.footer?.hasSubmitButton ||
            modalConfig.footer?.hasSubmitButton === undefined
          "
          >确定</el-button
        >
      </span>
