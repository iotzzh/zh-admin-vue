<template>
  <div class="nav">
    <el-scrollbar class="scrollbar" v-if="mode === 'vertical'">
      <el-menu class="menu" :mode="mode" :collapse="!collapse" router :default-active="$route.path"
        @select="changeSelectMenu">
        <menu-item v-for="route in menuList" :key="route.id" :item="route"></menu-item>
      </el-menu>
    </el-scrollbar>

    <el-menu v-else class="menu" :mode="mode" :collapse="!collapse" router :default-active="$route.path"
      @select="changeSelectMenu">
      <menu-item v-for="route in menuList" :key="route.id" :item="route"></menu-item>
    </el-menu>
  </div>
...
.el-menu.el-menu--horizontal.menu {
  ...
  // --el-menu-bg-color: rgb(12, 33, 53);
  --el-menu-bg-color: var(--el-menu-hover-bg-color);
  // --el-menu-hover-bg-color: rgba(9,96,189, 0.8) !important;
