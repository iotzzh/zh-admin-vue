  ...
  <div class="tags-box">
    <el-scrollbar class="tags-scrollbar tags">
      <el-tag class="tag" v-for="cachedView in cachedViews" :key="cachedView?.path" closable
        :type="isActive(cachedView) ? 'primary' : 'info'" @click="clickTab(cachedView.fullPath)"
...
const toggleFullScreen = () => {
  UIHelper.toggleFullScreen(document.querySelector('.app-main div'), !fullScreen.value);
