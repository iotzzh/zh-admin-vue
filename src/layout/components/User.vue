<template>
  <div class="info">
    <span class="item github">
      <i class="iconfont icon-github" @click="openGithub"></i>
    </span>
    ...
    <span class="item">
      <i
        ...
        class="iconfont icon-charts-buju"
        @click="clickChangeLayout"
      ></i>
    ...
    <el-dropdown :hide-on-click="false" class="name" @command="handleCommand">
      <span>
        <el-avatar :size="23" style="margin-right: 5px; margin-left: 10px"
          >{{ pinyinFL }} </el-avatar
        >{{ userName }}
      </span>
      <template #dropdown>
...
<script lang="ts" setup>
  ...
  const openGithub = () => {
    window.open('https://github.com/iotzzh/zh-admin-vue');
  };
</script>
