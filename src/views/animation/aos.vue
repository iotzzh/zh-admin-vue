<template>
    <Box :use-scroll-content-box="true" @scroll="scroll"  data-aos-easing="ease-out-back" data-aos-duration="1000" data-aos-delay="0" class="scroll-box">
		...
		<header class="hero">
			<div class="hero-center">
				...
				<h2 class="hero__text aos-init aos-animate" data-aos="fade-up" data-aos-easing="ease" data-aos-delay="400">Animate On Scroll <span>Library</span></h2>
			</div>
