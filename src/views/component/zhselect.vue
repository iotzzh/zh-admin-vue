        ...
        <pane>
            <div class="show-box" style="overflow-y: auto; height: 100%; text-align: center;">
                ...
                <ZHSelect 
                    ...
                    :value-field="model.valueField"></ZHSelect>
...
watch(model.value, async (newVal:any) => {
    if (newVal.dataSource === 'options') {
        ...
        refSelect.value.setOptions([{ label: '测试1', value: '测试1' },{ label: '测试2', value: '测试2' }]);
        await nextTick();
...
<script lang="ts">export default { name: 'select-example' }; </script>
