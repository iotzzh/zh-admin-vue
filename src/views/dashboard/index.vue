  ...
  <div class="box">
    ...
    <el-row class="row" :gutter="20">
      <el-col :md="12" :sm="12" :xs="24"
        ><div class="column">
          <div v-loading="loading1" class="chart chart1"></div></div
      ></el-col>
      <el-col :md="12" :sm="12" :xs="24"
        ><div class="column">
          <div v-loading="loading2" class="chart chart2"></div></div
      ></el-col>
    </el-row>
    ...
    <el-row class="row" :gutter="20">
      <el-col :md="12" :sm="12" :xs="24"
        ><div class="column">
          <div v-loading="loading3" class="chart chart3"></div></div
      ></el-col>
      <el-col :md="12" :sm="12" :xs="24"
        ><div class="column">
          <div v-loading="loading4" class="chart chart4"></div></div
      ></el-col>
    </el-row>
  </div>
</template>
