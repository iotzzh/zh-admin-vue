    ...
    const pageConfig = {
        table: {
            ...
            requestConfig: {
                ...
                add: { url: api.addDepartment, successMessage: '新增成功', errorMessage: '新增失败' },
                update: { url: api.updateDepartment, successMessage: '更新成功', errorMessage: '更新失败' },
                delete: { url: api.deleteDepartment, successMessage: '删除成功', errorMessage: '删除失败' },
                batchDelete: { url: api.batchDeleteDepartment, successMessage: '批量删除成功', errorMessage: '批量删除失败' },
            },
            pageConfig: {},
        },
    };
